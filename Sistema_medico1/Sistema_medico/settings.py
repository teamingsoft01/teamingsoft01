...
SECRET_KEY = 'django-insecure-&s!)_02v2@&q+=#run9948oy*3zr&)5+#x2*0(2n6w)u0t%pje'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['C:/Users/MSI/Desktop/cumputacion/ipn/semetres6/INGENIERIA_DE_SOFTWARE/Proyecto_pagina_web/final/Sistema_medico1/Sistema_medico/Template'],  # ruta para extraer las paginas web
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
